    ...
    <div class="relative w-full max-w-5xl px-6 md:px-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div class="hidden md:flex flex-col gap-6 pl-4">
                ...
                <h1 class="text-4xl md:text-5xl font-bold leading-tight">Nueva Contraseña</h1>
                <p class="text-lg text-muted-foreground max-w-lg">
                    Crea una nueva contraseña segura para tu cuenta. Asegúrate de que sea única y difícil de adivinar.
                </p>
                <div class="flex items-center gap-3 text-sm text-muted-foreground">
                    ...
                    <span class="tracking-[0.18em] uppercase text-xs">Protección de cuenta</span>
                </div>
            </div>
                ...
                <div class="relative rounded-3xl border border-white/60 bg-white/80 backdrop-blur-2xl shadow-2xl p-8 md:p-10 glass-surface">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-2xl font-bold mt-1">Actualizar</p>
                        </div>
                    ...
                    <form wire:submit.prevent="store" class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <x-ui.input id="password" type="password" wire:model="password" placeholder="••••••••"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <x-ui.input id="password_confirmation" type="password" wire:model="password_confirmation" placeholder="••••••••"
                                    class="pl-11 bg-white/70 border-white/70 focus-visible:ring-ring focus-visible:border-black" required />
                                <x-lucide-check-circle class="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                            </div>
                        ...
                        <div class="pt-2">
                            <x-ui.button type="submit" class="w-full bg-black text-white hover:bg-red-600">
                                <span class="tracking-[0.2em]">Cambiar contraseña</span>
